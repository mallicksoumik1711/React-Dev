function TodoLocalStorage() {
    return (
        <>
            <div className="flex">
                <div className="w-1/2 p-10 bg-red-900">
                    ...
                    <form className="flex flex-col flex-wrap gap-10">
                        ...
                        <button className="bg-black py-4 rounded-full">Submit</button>
                    </form>
                </div>
                <div className="w-1/2 p-10 flex flex-wrap gap-5 bg-yellow-900">
                    <div className="bg-green-900 w-1/3 overflow-hidden rounded-xl">
                        <div className="h-60">
